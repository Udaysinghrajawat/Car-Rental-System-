...
namespace Car_Rental_System {
    ...
    public partial class CarRentalDataSet : global::System.Data.DataSet {
        ...
        public partial class carDataTable : global::System.Data.TypedTableBase<carRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public carRow AddcarRow(string RegNo, string Brand, string Model, int price, string Available) {
...
namespace Car_Rental_System.CarRentalDataSetTableAdapters {
    ...
    public partial class carTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[car] WHERE (([RegNo] = @Original_RegNo) AND ([Brand] = @Origin" +
                "al_Brand) AND ([Model] = @Original_Model) AND ([price] = @Original_price) AND ((" +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[car] ([RegNo], [Brand], [Model], [price], [Available]) VALUES " +
                "(@RegNo, @Brand, @Model, @price, @Available);\r\nSELECT RegNo, Brand, Model, price" +
                ", Available FROM car WHERE (RegNo = @RegNo)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[car] SET [RegNo] = @RegNo, [Brand] = @Brand, [Model] = @Model, [price] = @price, [Available] = @Available WHERE (([RegNo] = @Original_RegNo) AND ([Brand] = @Original_Brand) AND ([Model] = @Original_Model) AND ([price] = @Original_price) AND ((@IsNull_Available = 1 AND [Available] IS NULL) OR ([Available] = @Original_Available)));
SELECT RegNo, Brand, Model, price, Available FROM car WHERE (RegNo = @RegNo)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT RegNo, Brand, Model, price, Available FROM dbo.car";
        ...
        public virtual int Delete(string Original_RegNo, string Original_Brand, string Original_Model, int Original_price, string Original_Available) {
        ...
        public virtual int Insert(string RegNo, string Brand, string Model, int price, string Available) {
            if ((RegNo == null)) {
        ...
        public virtual int Update(string RegNo, string Brand, string Model, int price, string Available, string Original_RegNo, string Original_Brand, string Original_Model, int Original_price, string Original_Available) {
            if ((RegNo == null)) {
                throw new global::System.ArgumentNullException("RegNo");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Brand, string Model, int price, string Available, string Original_RegNo, string Original_Brand, string Original_Model, int Original_price, string Original_Available) {
